...
combined_junctions = "/gpfs/commons/projects/knowles_singlecell_splicing/PRJEB14362/LeafletFA/ATSEs/022025/junction_processing_20250210/results"
output_path = "/gpfs/commons/projects/knowles_singlecell_splicing/PRJEB14362/LeafletFA/ATSEs/022025/output/"
...
genome_db = GenomeDB(db_name="gencodeHumanv45", gtf_file=gtf_file, fasta_file=fasta_file)
...
# script_path=/gpfs/commons/home/kisaev/Leaflet-analysis/PRJEB14362_iPSC/data_processing/ATSE_mapping/04_ATSEmapping.py
# sbatch --wrap="python $script_path" --mem=300G --time=3-00:00:00 -J iPSCLeafletFA -p bigmem
