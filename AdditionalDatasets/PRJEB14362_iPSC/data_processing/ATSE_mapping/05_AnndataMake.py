...
# Constants
METADATA_PATH = "/gpfs/commons/projects/knowles_singlecell_splicing/PRJEB14362/LeafletFA/ATSEs/metadata_2024-11-24.tsv"
INTRON_CLUSTS_FILE = "/gpfs/commons/projects/knowles_singlecell_splicing/PRJEB14362/LeafletFA/ATSEs/022025/output/TMS_atse_file_unanno_also_2025-02-11_21-50-55.txt.gz"
BATCH_SIZE = 10
MAX_WORKERS = 4
...
def main():
    ...
    # Ensure "cell_id" column is present in metadata
    if "cell_id" not in metadata.columns:
        raise ValueError("Metadata file must contain a 'cell_id' column")
