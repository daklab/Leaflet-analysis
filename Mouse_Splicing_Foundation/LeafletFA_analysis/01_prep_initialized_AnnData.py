...
def save_prepared_anndata(splice_adata):
    ...
    try:
        ...
        output_filename = f"MOUSE_SPLICING_FOUNDATION_Anndata_ATSE_counts_with_waypoints_{timestamp}.h5ad"
        ...
        # Save AnnData object
        print(f"   ⚙️ Saving AnnData to {output_path}...")
        splice_adata.write_h5ad(output_path, compression='gzip')
