...
base_output_dir = "/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/EasySci2024/LeafletFA/MetaCells/leafletFAmodel/2025-03-03/"
...
cell_tye_silhouette = ds.calculate_silhouette_score(leaflet_model.assign_post, adata.obs.Cleaned_cluster_name.values)
age_silhouette = ds.calculate_silhouette_score(leaflet_model.assign_post, adata.obs.Type.values)
...
with plt.rc_context({'figure.figsize': (10, 7), 'savefig.dpi': 300}):  
    sc.pl.umap(
        adata, 
        color=["Cleaned_cluster_name", "Type"], 
        wspace=0.9, 
