...
output_file = os.path.join(output_path, "EasySci_DT_Metacells" )

# Get today's date and add to junc_bed_file
today = datetime.datetime.now()
junc_bed_file = os.path.join(output_path, "EasySci_DT_Metacells_ATSEs_junctions")
...
## to submit:
# cd /gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/EasySci2024/LeafletFA/MetaCells/ATSEs/DT
# conda activate LeafletSC
# script_path=/gpfs/commons/home/kisaev/Leaflet-analysis/EasySci/LeafletFA/data_processing/ATSE_mapping/DT/00_ATSE_mapping.py
# sbatch --wrap="python $script_path" --mem=300G --time=3-00:00:00 -J EasySciDT 
