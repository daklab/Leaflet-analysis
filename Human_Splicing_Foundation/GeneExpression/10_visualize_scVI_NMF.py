...
# script=/gpfs/commons/home/kisaev/Leaflet-analysis/Human_Splicing_Foundation/GeneExpression/10_visualize_scVI_NMF.py
# sbatch --mem=350G -p cpu,bigmem -J "HS_GE_UMAPs" --wrap="python $script"
