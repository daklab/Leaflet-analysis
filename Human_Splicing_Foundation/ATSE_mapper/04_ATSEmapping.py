...
genome_db = GenomeDB(db_name="/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/HUMAN_SPLICING_FOUNDATION/ATSE_mapper/v45hg38", gtf_file=gtf_file, fasta_file=fasta_file)
...
# sbatch --wrap="python $script_path" --mem=300G --time=2-00:00:00 -J human_splice_ATSE -p bigmem
# sbatch --wrap="python $script_path" --mem=100G --time=2-00:00:00 -J human_splice_ATSE -p cpu
