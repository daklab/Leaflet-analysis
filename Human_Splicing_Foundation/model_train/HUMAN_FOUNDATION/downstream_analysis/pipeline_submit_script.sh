...
ATSE_ANNDATA_PATH="${BASE_DIR}/MODEL_INPUT/062025/HUMAN_SPLICING_FOUNDATION_Anndata_ATSE_counts_53449_junctions_30_waypoints_20250612_110451.h5ad"
GE_ANNDATA_scVI_PATH="${BASE_DIR}/scVI/ge_adata_with_both_scvi_models_2025-06-06.h5ad"
GE_ANNDATA_NMF_PATH="${BASE_DIR}/NMF/ge_adata_with_NMF_model_50_1024_2025-06-06.h5ad"
...
for ((i=0; i<=num_rows-1; i++)); do
    ...
    OUTPUT_DIR="${RESULTS_BASE_DIR}/param_id_${i}"
    ...
    sbatch --mem=450G -p cpu,bigmem -J "H_evaluate_leafletFA_results_$i" --wrap="python $script1 $i $MODEL_OUTPUTS_DIR $ATSE_ANNDATA_PATH $GE_ANNDATA_scVI_PATH $AGING_GENES_PATH $RBP_FILE_PATH $OUTPUT_DIR"
    sbatch --mem=350G -p cpu,bigmem -J "H_leafletFA_regressions_$i" --wrap="python $script2 $i $MODEL_OUTPUTS_DIR $ATSE_ANNDATA_PATH $GE_ANNDATA_scVI_PATH $GE_ANNDATA_NMF_PATH $AGING_GENES_PATH $RBP_FILE_PATH $OUTPUT_DIR"
...
# cd /gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/HUMAN_SPLICING_FOUNDATION/Leaflet/leafletFAmodel
...
#GE_ANNDATA_NMF_PATH="/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/HUMAN_SPLICING_FOUNDATION/NMF/ge_adata_with_NMF_model_50_1024_2025-06-06.h5ad"
#GE_ANNDATA_scVI_PATH="/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/HUMAN_SPLICING_FOUNDATION/scVI/ge_adata_with_both_scvi_models_2025-06-06.h5ad"
#ATSE_ANNDATA_PATH="/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/HUMAN_SPLICING_FOUNDATION/MODEL_INPUT/062025/HUMAN_SPLICING_FOUNDATION_Anndata_ATSE_counts_53449_junctions_30_waypoints_20250612_110451.h5ad"