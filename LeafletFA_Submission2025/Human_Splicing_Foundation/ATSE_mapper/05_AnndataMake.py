...
def main():
    ...
    with open('/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/HUMAN_SPLICING_FOUNDATION/ATSE_mapper/junction_processing_20250920/results/final_junctions.pkl', 'rb') as f:
