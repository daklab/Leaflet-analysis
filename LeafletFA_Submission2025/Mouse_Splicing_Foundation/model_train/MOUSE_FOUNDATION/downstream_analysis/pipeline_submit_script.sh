...
ATSE_ANNDATA_PATH="${BASE_DIR}/MODEL_INPUT/102025/model_ready_aligned_splicing_data_20251009_024406.h5ad"
GE_ANNDATA_scVI_PATH="${BASE_DIR}/scVI/ge_adata_with_scvi_model_latent_20_20000_2025-10-09.h5ad"
GE_ANNDATA_NMF_PATH="${BASE_DIR}/NMF/ge_adata_with_NMF_standard_20_1024_2025-08-03.h5ad"
...
ATSE_FILE_PATH="${BASE_DIR}/ATSE_mapper/ATSE_files/MOUSE_FOUNDATION_ATSE_FILE_unanno_also_2025-10-01_21-36-40.txt.gz"
...
for ((i=0; i<=num_rows-1; i++)); do
    ...
    sbatch --mem=350G -p cpu,bigmem -J "leafletFA_regressions_$i" --wrap="python $script2 $i $MODEL_OUTPUTS_DIR $ATSE_ANNDATA_PATH $GE_ANNDATA_scVI_PATH $AGING_GENES_PATH $RBP_FILE_PATH $OUTPUT_DIR"
    # sbatch --mem=300G -p cpu,bigmem -J "differential_splicing_analysis_$i" --wrap="python $script3 $i $MODEL_OUTPUTS_DIR $ATSE_ANNDATA_PATH $ATSE_FILE_PATH $GE_ANNDATA_scVI_PATH $AGING_GENES_PATH $RBP_FILE_PATH $OUTPUT_DIR"
