...
def main():
    ...
    summary_df["prior_combo"] = (
        ...
        summary_df["junc_specific_prior"].astype(str) + "_" + 
        summary_df["lr"].astype(str) + summary_df["gamma"].astype(str)
    )
...
#        "celltype_classification_accuracy",
    ...
    for metric in metrics_to_plot:
        ...
        plt.xlabel("Model parameters used", fontsize=12)
    ...
    g = sns.clustermap(heatmap_df_scaled,
                   annot=False, 
                   cmap="YlGnBu",
                   yticklabels=True, xticklabels=True,
                       figsize=(12, 10)) 
            
    # Decrease x-axis tick font size
