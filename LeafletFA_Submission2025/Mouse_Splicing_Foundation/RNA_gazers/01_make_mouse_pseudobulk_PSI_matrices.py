...
# Output directory
output_dir = "/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/MOUSE_SPLICING_FOUNDATION/MODEL_INPUT/112025"
...
splice_adata.obs["age_numeric"] = splice_adata.obs["age"].str.replace("m", "").astype(int)
...
def assign_age_group(age):
    if age in young_ages:
        ...
        return "old"
    return "other"
splice_adata.obs["age_group"] = splice_adata.obs["age_numeric"].apply(assign_age_group)
...
def create_pseudobulk(adata, group_by, min_cells=50, layer=None):
    ...
    meta_columns = ["dataset", "tissue", "age"]
