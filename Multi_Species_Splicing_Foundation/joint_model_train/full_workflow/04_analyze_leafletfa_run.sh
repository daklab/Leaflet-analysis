...
model_output=/gpfs/commons/groups/knowles_lab/Karin/Leaflet-analysis-WD/CROSS_SPECIES_AGING/Leaflet/model_combo_train/2025-09-18
cd $model_output
...
for run_dir in run_*; do
    ...
    if [ -f "${run_dir}/leafletfa_model.pkl.gz" ]; then
        ...
        sbatch --job-name=leaf_${param_id} \
               ...
               --wrap="python $script $param_id $model_output $output_dir $batch_column $cell_type_column"
