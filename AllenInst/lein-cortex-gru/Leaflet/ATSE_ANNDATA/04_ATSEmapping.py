...
combined_junctions = "/gpfs/commons/datasets/controlled/BRAIN_NeMO/lein-human-cortex/junction_processing_20250304/results"
output_path = "/gpfs/commons/datasets/controlled/BRAIN_NeMO/lein-human-cortex/ATSEfiles"
...
genome_db = GenomeDB(db_name="GrCh38_v45", gtf_file=gtf_file, fasta_file=fasta_file)
...
## to submit:
# cd /gpfs/commons/datasets/controlled/BRAIN_NeMO/lein-human-cortex/ATSEfiles
# conda activate LeafletSC
# script_path=/gpfs/commons/home/kisaev/Leaflet-analysis/AllenInst/lein-cortex-gru/Leaflet/ATSE_ANNDATA/04_ATSEmapping.py
# sbatch --wrap="python $script_path" --mem=300G --time=3-00:00:00 -J HUMAN_AB_ATSE -p bigmem
