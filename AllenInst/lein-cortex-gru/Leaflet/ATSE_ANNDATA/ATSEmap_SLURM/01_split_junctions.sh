...
JUNCTION_FILES=/gpfs/commons/datasets/controlled/BRAIN_NeMO/lein-human-cortex/Leaflet
WD=/gpfs/commons/datasets/controlled/BRAIN_NeMO/lein-human-cortex/ATSEmap
