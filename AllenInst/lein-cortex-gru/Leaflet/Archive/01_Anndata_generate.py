...
intron_clusts_path = "lein-human-cortex_with_annotations_50_500000_100_20250106_single_cell.gz"
...
WD = "/gpfs/commons/datasets/controlled/BRAIN_NeMO/lein-human-cortex/LeafletAnalysis/JAN2025/ATSEs"
...
for i in range(num_batches):
    ...
    adata = create_anndata_object(cell_by_junction_matrix, cell_by_cluster_matrix, cell_idx, junc_idx, metadata, intron_clusts, meta_cell_column="sample_name")
...
# script_path=/gpfs/commons/home/kisaev/Leaflet-analysis/AllenInst/lein-cortex-gru/Leaflet/01_Anndata_generate.py
# sbatch --wrap="python $script_path" --mem=200G --time=3-00:00:00 -J lein-human-cortex -p gpu
