...
CELL_TYPE_COLUMN_VALUES=("day")  # Add None as an option?
...
input_file=${WD}/ATSE_Anndata_noGTF_Object_with_initializations_wGTFannot_20241203_111855.h5ad
ATSE_file=${WD}/iPSC_human_cells_with_annotations_50_500000_500_20241126_single_cell.gz
