...
output_file = os.path.join(output_path, "tabula-sapien" )

# Get today's date and add to junc_bed_file
today = datetime.datetime.now()
junc_bed_file = os.path.join(output_path, "tabula-sapien_ATSEs_junctions")
...
# script_path=/gpfs/commons/home/kisaev/Leaflet-analysis/tabula_sapien/Leaflet/Code/00_ATSE_mapping.py
# sbatch --wrap="python $script_path" --mem=300G --time=3-00:00:00 -J TabulaSapien -p bigmem
